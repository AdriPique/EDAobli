...
//POS: solo muestra el texto linea por linea, funcion auxiliar a MostrarTexto
...
//POS: retorna el numero de lineas de texto de una version
//PRE: recibe un puntero al primwr elemento de una lista o uno nulo en caso de lista vacia
